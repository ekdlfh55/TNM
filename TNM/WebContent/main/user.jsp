			                        ...
			                        <div class="thumbnails thumbnail-style thumbnail-kenburn">
			                            <div class="thumbnail-img">
			                                <div class="overflow-hidden">
			                                    <img style="width: 150px;height: 150px;" class="img-responsive" src="<%=cp%>/res/main/assets/img/album/album1.jpg" alt="" />
			                                </div>
	                            ...
	                            <td>
	                            	<div class="col-md-3">
				                        ...
				                        <div class="thumbnails thumbnail-style thumbnail-kenburn">
				                            <div class="thumbnail-img">
				                                <div class="overflow-hidden">
				                                    <img style="width: 150px;height: 150px;" class="img-responsive" src="<%=cp%>/res/main/assets/img/album/album2.jpg" alt="" />
				                                </div>
				                                <a class="btn-more hover-effect" data-toggle="modal" data-target="#responsive1" style="cursor: pointer;">read more +</a>
