                                        ...
                                        <div class="row equal-height">
                                            ...
                                            <div class="col-md-3 equal-height-in">
                                                <ul class="list-unstyled equal-height-list">
                                                    ...
                                                    <li class="active"><a href="shortcode_form_sliders.html"><i class="fa fa-bars"></i> Form Sliders</a></li>
            ...
            <div class="col-md-9">
                ...
                <div class="tab-v1">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#home-1" data-toggle="tab">앨범</a></li>
                        ...
                        <div class="tab-pane fade in active" id="home-1">
                            <form action="#" class="sky-form">
                                ...
                                <fieldset>
                                    ...
                                    <section>
                                        <label class="label">앨범표지선택</label>
                                     ...
                                     <section>
                                        <label class="label">시디사진선택</label>
                                        <label for="file" class="input input-file state-success">
                                            <div class="button"><input type="file" id="file" onchange="this.parentNode.nextSibling.value = this.value">Browse</div><input type="text" readonly>
                                        </label>
                                        <div class="note note-success">This is a required field.</div>
                               ...
                               <!--  <fieldset>
                                    <section>
                                        <label class="label">노래곡수</label>
                                        <label class="select state-success">
                                            <select>
                                                <option value="0">10곡(30000원)</option>
...
<!-- 
 ...
 -->
                                <footer>
                                    <button type="submit" class="btn-u btn-u-default">저장</button>
...
<script src="<%=cp%>/res/main/assets/plugins/sky-forms-pro/skyforms/js/jquery.form.min.js"></script>
<!-- JS Customization -->
