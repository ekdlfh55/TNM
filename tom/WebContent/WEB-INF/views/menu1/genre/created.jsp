...
<script type="text/javascript">
	function genreBoardcheck() {
		var f=document.genreboardForm;
		...
		var mode="${mode}";
		if(mode=="created")
			f.action="<%=cp%>/genre/created";
		else if(mode=="update")
			f.action="<%=cp%>/genre/update";				
		return true;			
	}
            ...
            <div class="col-md-9">
                ...
                <div class="panel panel-grey margin-bottom-40">
                   <div class="panel-heading">
                        <h3 class="panel-title"><i class="fa fa-tasks"></i>가요게시판 글쓰기</h3>
                    </div>
                    <div class="panel-body">
                <form action="#" class="sky-form" name="genreboardForm" onsubmit="return genreBoardcheck();" method="post">
