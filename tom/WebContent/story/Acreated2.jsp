                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown active">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="active"><a href="feature_testimonials_quotes.html">Testimonials and Quotes</a></li>
    ...
    <div class="container content-sm">
        ...
        <div class="testimonials-v6 testimonials-wrap">
            <div class="row margin-bottom-50">
                <div class="col-md-6 md-margin-bottom-50">
                    <div class="testimonials-info rounded-bottom bg-color-light">
                        <img class="rounded-x" src="<%=cp%>/res/main/assets/img/show.jpg" alt="">
                        ...
                        <div class="testimonials-desc">
                            ...
                            <span>Web Developer</span>
                              <footer>
                                    <button type="submit" class="btn-u btn-u-default">노래담기</button>
                                    <button type="button" class="btn-u" onclick="window.history.앨범삭제();">앨범삭제</button>
                                </footer>
                        </div>
                    </div>
                </div>
            ...
            <div class="row margin-bottom-20">
                <div class="col-md-6 md-margin-bottom-50">
                    <div class="testimonials-info rounded-bottom bg-color-light">
                        <img class="rounded-x" src="<%=cp%>/res/main/assets/img/testimonials/img3.jpg" alt="">
                        <div class="testimonials-desc">
                            <p>Donec quis lorem sit amet nibh tempor porttitor non eu justo. Fusce iaculis scelerisque nibh at rhoncus. Aliquam blandit.</p>
            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <ul class="list-unstyled owl-ts-v1">
                        <li class="item">
                            <img class="rounded-x img-bordered" src="<%=cp%>/res/main/assets/img/team/img3-sm.jpg" alt="">
                        ...
                        <li class="item">
                            <img class="rounded-x img-bordered" src="<%=cp%>/res/main/assets/img/team/img2-sm.jpg" alt="">
                            <div class="testimonials-v3-title">
                                <p>Tina Krueger</p>
                        ...
                        <li class="item">
                            <img class="rounded-x img-bordered" src="<%=cp%>/res/main/assets/img/team/img1-sm.jpg" alt="">
                            <div class="testimonials-v3-title">
                                <p>John Clarck</p>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="testimonials-v4 md-margin-bottom-50">
                        ...
                        <img class="rounded-x" src="<%=cp%>/res/main/assets/img/testimonials/img5.jpg" alt="thumb">
                ...
                <div class="col-sm-6">
                    <div class="testimonials-v4">
                        ...
                        <img class="rounded-x" src="<%=cp%>/res/main/assets/img/testimonials/img4.jpg" alt="thumb">
                        <span class="testimonials-author">
                            John Davenport<br>
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="flat-testimonials-in md-margin-bottom-50">
                        <img class="rounded-x img-responsive" src="<%=cp%>/res/main/assets/img/team/img1-sm.jpg" alt="">
                ...
                <div class="col-sm-4">
                    <div class="flat-testimonials-in md-margin-bottom-50">
                        <img class="rounded-x img-responsive" src="<%=cp%>/res/main/assets/img/team/img2-sm.jpg" alt="">
                        <h3>Angela Danil</h3>
                ...
                <div class="col-sm-4">
                    <div class="flat-testimonials-in">
                        <img class="rounded-x img-responsive" src="<%=cp%>/res/main/assets/img/team/img3-sm.jpg" alt="">
                        <h3>Anthony Connor</h3>
                        <span class="color-green">Software Developer</span>
                        <p>Proin et augue vel nisi rhoncus tincidunt. Cras venenatis, magna id sem ipsum mi interduml</p>
                    </div>
                ...
                <div class="row margin-bottom-50">
                    <div class="col-md-6 md-margin-bottom-50">
                        <div class="testimonials-info rounded-bottom">
                            <img class="rounded-x" src="<%=cp%>/res/main/assets/img/testimonials/img5.jpg" alt="">
                            <div class="testimonials-desc">
                                <p>Donec quis lorem sit amet nibh tempor porttitor non eu justo. Fusce iaculis scelerisque nibh at rhoncus. Aliquam blandit.</p>
                                <strong>Evan Bohringer</strong>
                                <span>Web Developer</span>
...
<script type="text/javascript" src="<%=cp%>/res/main/assets/plugins/앨범삭제-to-top.js"></script>
<script type="text/javascript" src="<%=cp%>/res/main/assets/plugins/smoothScroll.js"></script>
<script type="text/javascript" src="<%=cp%>/res/main/assets/plugins/jquery.parallax.js"></script>
