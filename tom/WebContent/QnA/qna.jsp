...
<head>
    <title>FAQ 1 Page | Unify - Responsive Website Template</title>
    ...
    <link rel="stylesheet" href="<%=cp%>/res/main/assets/css/footers/footer-default.css">
    ...
    <!-- CSS Page Style -->
    <link rel="stylesheet" href="<%=cp%>/res/main/assets/css/pages/page_faq1.css">
...
<div class="wrapper">
    ...
    <div class="container content faq-page">
        ...
        <div class="row">
        	<div class="col-md-12">
                <div class="headline"><h2>자주하는 질문</h2></div>
            ...
            <!-- Begin Tab v1 -->
            <div class="col-md-12">
            	<div class="headline"><h2>QnA</h2></div>
                <div class="tab-v1">
                    <ul class="nav nav-tabs margin-bottom-20">
                        <li class="active"><a data-toggle="tab" href="#home">계정/회원</a></li>
                        <li><a data-toggle="tab" href="#profile">결제</a></li>
                        <li><a data-toggle="tab" href="#messages">게시판</a></li>
                        <li><a data-toggle="tab" href="#settings">CD제작</a></li>
                        <li><a data-toggle="tab" href="#settings">이벤트</a></li>
                        <li><a data-toggle="tab" href="#settings">음악</a></li>
                    </ul>
            ...
            <div class="col-sm-4 no-space">
                <div class="easy-block-v3 equal-height-column first">
                    ...
                    <div class="inner-faq-b">
                        <h3>Contact Us</h3>
                        <h4>(02)-2222-2222</h4>
                        <p>고객 센터는 평일 09:00~18:00까지 운영합니다</p>
                    </div>
                </div>
            </div>
            <div class="col-sm-4 no-space">
                <div class="easy-block-v3 equal-height-column second">
                    ...
                    <div class="inner-faq-b">
                        <h3>Email Us</h3>
                        <h4>TomandMuzik@tam.com</h4>
                        <p>기타문의 사항은 이메일로 보내주셔도 됩니다.</p>
                    </div>
                </div>
            </div>
            <div class="col-sm-4 no-space">
...
<script type="text/javascript" src="<%=cp%>/res/main/assets/plugins/counter/waypoints.min.js"></script>
<script type="text/javascript" src="<%=cp%>/res/main/assets/plugins/counter/jquery.counterup.min.js"></script>
<script type="text/javascript" src="http://maps.google.com/maps/api/js?sensor=true"></script>
<script type="text/javascript" src="<%=cp%>/res/main/assets/plugins/gmap/gmap.js"></script>
<!-- JS Customization -->
...
<script type="text/javascript" src="<%=cp%>/res/main/assets/js/pages/page_contacts.js"></script>
