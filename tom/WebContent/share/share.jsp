...
<head>
    <title>Blog Medium Right Sidebar | Unify - Responsive Website Template</title>
    ...
    <!-- CSS Page Style -->
    <link rel="stylesheet" href="<%=cp%>/res/main/assets/css/pages/blog.css">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="dropdown-submenu active">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="active"><a href="blog_medium_right_sidebar.html">Right Sidebar Medium</a></li>
